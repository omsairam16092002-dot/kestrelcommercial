...
export const PUBLIC_PAGES = [
  ...
  { path: "/about", markers: [/About us|Jignesh Jhanjaria|Selected Sales & Leasing Experience|Why We're the Choice/i] },
  { path: "/services", markers: [/Private Treaty or EOI|The Right Tenant|Strategic Oversight|Clarity\. Strategy/i] },
